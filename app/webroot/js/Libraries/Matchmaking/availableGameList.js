...
function availableGameList(){
	...
	this.getGameElement = function( gameObject ){
		...
		return '<div class="playGameButton">' +
			'<a href="/turns/Games/playGame/?gameUID='+gameObject.games_uid+'">'+
				'Play Game '+gameObject.games_uid+
			'</a> '+
			'<a href="/turns/Games/forfeitGame/?gameUID='+gameObject.games_uid+'">'+
				'(Forfeit)'+
			'</a>'
		'</div>';
